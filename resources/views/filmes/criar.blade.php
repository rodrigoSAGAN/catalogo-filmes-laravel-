                    ...
                    <form action="{{ route('movies.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <div class="flex items-center">
                                <input type="checkbox" id="is_series" name="is_series" value="1"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="personal_comment" name="personal_comment" rows="3"
                                class="mt-1 block w-full rounded-md bg-gray-700 border-gray-600 text-gray-100 placeholder-gray-400 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm"></textarea>
                        </div>
